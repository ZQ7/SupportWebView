...
import com.yi2580.supportwebview.jsbridge.WebViewJavascriptBridge;
...
public class SupportWebView extends WebView implements WebViewJavascriptBridge {

    private final String TAG = "SupportWebView";
    ...
    public SupportWebView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected SupportWebViewClient generateBridgeWebViewClient() {
        return new SupportWebViewClient(this);
    }
